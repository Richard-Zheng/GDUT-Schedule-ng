...
const config = {
    AUTHLOGIN_URL: 'https://authserver.gdut.edu.cn/authserver/login?service=http%3A%2F%2Fjxfw.gdut.edu.cn%2Fnew%2FssoLogin',
    PWD_ENCRYPT_SALT_REGEX: /.*<input type="hidden" id="pwdDefaultEncryptSalt" value="(\S+)"\/?>/
};
